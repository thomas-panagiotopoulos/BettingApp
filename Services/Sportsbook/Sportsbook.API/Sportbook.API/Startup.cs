...
using BettingApp.Services.Sportbook.API.AutofacModule;
...
namespace BettingApp.Services.Sportbook.API
{
    public class Startup
    {
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<MatchCreatedIntegrationEvent, IIntegrationEventHandler<MatchCreatedIntegrationEvent>>();
    ...
    static class CustomExtensionsMethods
    {
        ...
        {
            services.AddDbContext<SportsbookContext>(options =>
            {
                                                               ...
                                                               IConfiguration configuration)
        {
            ...
            services.AddTransient<ISportsbookIntegrationEventService, SportsbookIntegrationEventService>();
                                                    ...
                                                    IConfiguration configuration)
        {
            ...
            // adds an authorization policy to make sure the token is for scope 'sportsbook'
            services.AddAuthorization(options =>
            {
                options.AddPolicy("SportsbookApiScope", policy =>
                {
                    policy.RequireAuthenticatedUser();
                    policy.RequireClaim("scope", "sportsbook");
                });
