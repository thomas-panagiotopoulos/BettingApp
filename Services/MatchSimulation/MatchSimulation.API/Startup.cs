...
using BettingApp.Services.MatchSimulation.API.AutofacModules;
...
namespace BettingApp.Services.MatchSimulation.API
{
    ...
    static class CustomExtensionsMethods
    {
        ...
        {
            services.AddDbContext<MatchSimulationContext>(options =>
            {
                                                               ...
                                                               IConfiguration configuration)
        {
            ...
            services.AddTransient<IMatchSimulationIntegrationEventService, MatchSimulationIntegrationEventService>();
