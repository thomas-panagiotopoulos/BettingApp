...
namespace BettingApp.WebApps.WebRazorPages.Infrastructure
{
    public static class API
    {
        ...
        {
            //public static string GetBetslip(string baseUri) => $"{baseUri}/home/GetBetslip";
            //
            //public static string CheckAddSelection(string baseUri, string matchId, int matchResultId) 
            //    => $"{baseUri}/home/CheckAddSelection?matchId={matchId}&matchResultId={matchResultId}";
            //
            //public static string AddSelection(string baseUri) => $"{baseUri}/home/AddSelection";
            //
            //public static string RemoveSelection(string baseUri, string selectionId) 
            //    => $"{baseUri}/home/RemoveSelection?selectionId={selectionId}";
            //
            //public static string UpdateWageredAmount(string baseUri, decimal wageredAmount)
            //    => $"{baseUri}/home/UpdateWageredAmount?wageredAmount={wageredAmount}";
            //
            //public static string ClearBetslip(string baseUri) => $"{baseUri}/home/ClearBetslip";
            //
            //public static string Checkout(string baseUri) => $"{baseUri}/home/Checkout";
            //
            //public static string GetWalletBalance(string baseUri) => $"{baseUri}/home/GetWalletBalance";
        ...
        {
            //public static string GetBet(string baseUri, string betId) => $"{baseUri}/home/GetBet?betId={betId}";
            //
            //public static string GetBetPreviewsPage(string baseUri, int pageNumber)
            //    => $"{baseUri}/home/GetBetPreviewsPage?pageNumber={pageNumber}";
            //
            //public static string GetBetPreviewsPagesCount(string baseUri) => $"{baseUri}/home/GetBetPreviewsPagesCount";
            //
            //public static string CancelBet(string baseUri, string betId) => $"{baseUri}/home/CancelBet?betId={betId}";
            //
            //public static string RequestExists(string baseUri, string requestId) => $"{baseUri}/home/RequestExists?requestId={requestId}";
        ...
        {
            //public static string GetWalletPreview(string baseUri) => $"{baseUri}/home/GetWalletPreview";
            //
            //public static string GetTransactionsPage(string baseUri, int pageNumber)
            //    => $"{baseUri}/home/GetTransactionsPage?pageNumber={pageNumber}";
            //
            //public static string GetTransactionsPagesCount(string baseUri) 
            //    => $"{baseUri}/home/GetTransactionsPagesCount";
            //
            //public static string RequestTopUp(string baseUri) => $"{baseUri}/home/RequestTopUp";
            //
            //public static string RequestWithdraw(string baseUri) => $"{baseUri}/home/RequestWithdraw";
            //
            //public static string TopUpRequestExists(string baseUri, string requestId) 
            //    => $"{baseUri}/home/TopUpRequestExists?requestId={requestId}";
            //
            //public static string WithdrawRequestExists(string baseUri, string requestId) 
            //    => $"{baseUri}/home/WithdrawRequestExists?requestId={requestId}";
        ...
        {
            //public static string GetNotificationsPreview(string baseUri) => $"{baseUri}/home/GetNotificationsPreview";
            //
            //public static string GetNotificationsPage(string baseUri, int pageNumber)
            //    => $"{baseUri}/home/GetNotificationsPage?pageNumber={pageNumber}";
            //
            //public static string ReadNotificationsPage(string baseUri, int pageNumber)
            //    => $"{baseUri}/home/ReadNotificationsPage?pageNumber={pageNumber}";
            //
            //public static string MarkAsReadAllNotifications(string baseUri)
            //    => $"{baseUri}/home/MarkAsReadAllNotifications";
            //
            //public static string GetNotificationsPagesCount(string baseUri)
            //    => $"{baseUri}/home/GetNotificationsPagesCount";
